...
## אופציונלי: גיליון נפרד להצבעות
אם תרצה לשמור את ההצבעות בגיליון נפרד, הוסף גם secret בשם `VOTES_GSHEET_ID`.
אם לא יוגדר, האפליקציה תשמור את ההצבעות באותו Google Sheet הראשי.
